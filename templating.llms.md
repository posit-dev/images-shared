...
References: - [Source Code](https://github.com/posit-dev/images-shared/tree/main/posit-bakery/posit_bakery/config/templating/macros) - [Jinja2 Template Designer Documentation](https://jinja.palletsprojects.com/en/stable/templates/)
...
- [Configuration Documentation](configuration.llms.md) — `bakery.yaml` schema reference
