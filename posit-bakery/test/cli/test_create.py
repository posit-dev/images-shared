...
def check_image(cli_test_tmpcontext, image_name) -> str:
    image_dir = cli_test_tmpcontext / image_name
    assert image_dir.is_dir()
    tpl_dir = cli_test_tmpcontext / image_name / "template"
...
def check_version(cli_test_tmpcontext, version, cli_test_image_name) -> str:
...
def check_default_templates(cli_test_tmpcontext, cli_test_image_name) -> None:
...
def check_base_image(cli_test_tmpcontext, base_image, cli_test_image_name) -> None:
...
def check_rendered_templates(cli_test_tmpcontext, cli_test_image_name, cli_test_version) -> None:
