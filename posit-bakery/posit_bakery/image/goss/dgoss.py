...
# Legacy error class - canonical definition is in posit_bakery.plugins.builtin.dgoss.errors.
# Kept here to avoid circular imports while this legacy module is pending removal (Task 12).
