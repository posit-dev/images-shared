...
class DGossCommand(BaseModel):
    ...
    platform: Annotated[str | None, Field(description="The target platform for the dgoss command.", default=None)]
...
class DGossSuite:
    def __init__(self, context: Path, image_targets: list[ImageTarget], platform: str | None = None):
        self.context = context
        self.image_targets = image_targets
        self.dgoss_commands = [DGossCommand.from_image_target(target, platform) for target in image_targets]
