...
def get_dependency_constraint_class(dependency_name: str) -> type[DependencyConstraint]:
    """Get the DependencyConstraint class for a given dependency name.

    :param dependency_name: The name of the dependency.

    :return: The corresponding DependencyConstraint class.
