...
```{mermaid}
%%| fig-cap: "Bakery Workflow Overview"
flowchart TD
...
```{mermaid}
%%| fig-cap: "Bakery Project Creation Workflow"
flowchart TD
...
```{mermaid}
%%| fig-cap: "Bakery Testing Workflow"
flowchart TD
...
```{mermaid}
%%| fig-cap: "Bakery Scanning Workflow"
flowchart TD
...
```{mermaid}
%%| fig-cap: "Bakery Publishing Workflow"
flowchart TD
...
```{mermaid}
%%| fig-cap: "Bakery Multiplatform Publishing Workflow"
flowchart TD
